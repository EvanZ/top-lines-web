...
export const loadSharedFilters = () => {
  try {
    ...
    return {
      ...
      sortByEz75: typeof data.sortByEz75 === 'boolean' ? data.sortByEz75 : null,
...
export const saveSharedFilters = (filters) => {
  ...
  const payload = {
    ...
    sortByEz75: typeof filters.sortByEz75 === 'boolean' ? filters.sortByEz75 : (typeof existing.sortByEz75 === 'boolean' ? existing.sortByEz75 : false),
